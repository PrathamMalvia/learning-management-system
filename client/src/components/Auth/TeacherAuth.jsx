...
function SignupForm({ toggleForm }) {
    ...
    const handleSubmit = (event) => {
        ...
        const userType = 'teacher'; // Set the user type based on your logic
    ...
    return (
        <form onSubmit={handleSubmit}>
            <h2 className="text-2xl font-bold mb-4 w-80 ">Teacher Sign Up</h2>
            <div className="mb-4">
...
function LoginForm({ toggleForm }) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <h2 className="text-2xl font-bold mb-4 w-80">Teacher Log In</h2>
            <div className="mb-4">
                <label htmlFor="email" className="block mb-2">
                    Email
                </label>
